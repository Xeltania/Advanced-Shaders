...
Shader::Shader(const char* vertexPath, const char* fragmentPath, const char* geometryPath, const char* tessControlPath, const char* tessEvalPath)
{
	...
	if (geometryPath != nullptr) gShaderFile.exceptions(std::ifstream::failbit | std::ifstream::badbit);
	if (tessControlPath != nullptr) tcShaderFile.exceptions(std::ifstream::failbit | std::ifstream::badbit);
	if (tessEvalPath != nullptr) teShaderFile.exceptions(std::ifstream::failbit | std::ifstream::badbit);
